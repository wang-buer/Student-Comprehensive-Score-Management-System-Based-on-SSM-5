...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('ruxiaoriqi')">入校日期<i id="ruxiaoriqiIcon" class="fa fa-sort"></i></th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var ruxiaoriqiCell  = document.createElement('td');

						  ruxiaoriqiCell.innerHTML = item.ruxiaoriqi;


			row.appendChild(ruxiaoriqiCell);
