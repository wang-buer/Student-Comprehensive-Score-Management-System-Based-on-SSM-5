...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>入校日期</label>
										<div id="ruxiaoriqiDate" class="input-append date form_datetime">
											<input id="ruxiaoriqi-input" name="ruxiaoriqi" size="15" type="text" readonly >
	...
	<script>
		...
		function dataBind(){
			...
			$("#ruxiaoriqi-input").val(ruleForm.ruxiaoriqi);
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.ruxiaoriqi != null && res.data.ruxiaoriqi != ''){

					$("#ruxiaoriqi-input").val(res.data.ruxiaoriqi);
					$('#ruxiaoriqiFileName').val(res.data.ruxiaoriqi)
					}
				}
			});  
            }
